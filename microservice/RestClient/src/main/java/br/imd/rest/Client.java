...
public class Client {
	...
	public void helloWorld() throws RestRequestException {
		...
		String uri = "http://localhost:8080/grupo/create/grupo 1";
...
//
//		restClient.createGroup("teste");
//
//		restClient.enterGroup(0, "Epitacio");
//
//		restClient.publishMessage(0, "Epitacio", "ASASDASD");
